...
def parse_csv(nombre_archivo, select, types, has_headers,silence_errors=False,gz=False):
    '''
...
def parse_csv1(nombre_archivo, select, types, has_headers,silence_errors=False,gz=False):
    '''
    #Parsea un archivo CSV en una lista de registros
'''
    if gz==True:
